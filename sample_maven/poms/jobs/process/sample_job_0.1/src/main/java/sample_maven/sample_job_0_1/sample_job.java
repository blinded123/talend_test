...
package sample_maven.sample_job_0_1;
...
/**
 * Job: sample_job Purpose: <br>
 * Description:  <br>
 * @author jgavina@solvento.local
 * @version 7.3.1.20210623_0656-patch
 * @status 
 */
public class sample_job implements TalendJob {
	static {System.setProperty("TalendJob.log", "sample_job.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(sample_job.class);
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "sample_job";
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_sRrv4BxAEey_uOq1-jZG0w", "0.1");
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(sample_job.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
resumeUtil.addLog("SYSTEM_LOG", "NODE:"+ errorComponent, "", Thread.currentThread().getId()+ "", "FATAL", "", exception.getMessage(), ResumeUtil.getExceptionStackTrace(exception),"");
	...
	public static class ContextBean {
		static String evaluate(String context, String contextExpression)
			...
			java.io.InputStream inContext = sample_job.class.getClassLoader()
					.getResourceAsStream("sample_maven/sample_job_0_1/contexts/" + context + ".properties");
			if (inContext == null) {
				inContext = sample_job.class.getClassLoader()
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_SAMPLE_MAVEN_sample_job = new byte[0];
    static byte[] commonByteArray_SAMPLE_MAVEN_sample_job = new byte[0];
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_SAMPLE_MAVEN_sample_job) {
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tFileInputDelimited_1{
                    ...
                    log4jParamters_tFileInputDelimited_1.append("Parameters:");
                            log4jParamters_tFileInputDelimited_1.append("FILENAME" + " = " + "\"C:/Users/Solvento/Downloads/5000-Records/5000 Records.csv\"");
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
			...
			if(footer_value_tFileInputDelimited_1 >0 || random_value_tFileInputDelimited_1 > 0){
				throw new java.lang.Exception("When the input source is a stream,footer and random shouldn't be bigger than 0.");				
						...
						try {
							fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited("C:/Users/Solvento/Downloads/5000-Records/5000 Records.csv", "ISO-8859-15",",","\n",true,1,0,
 ...
 */
    ...
    public static void main(String[] args){
        final sample_job sample_jobClass = new sample_job();

        int exitCode = sample_jobClass.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'sample_job' - Done.");
	        }
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
        	...
        	log.info("TalendJob: 'sample_job' - Start.");
        ...
        try {
            ...
            java.io.InputStream inContext = sample_job.class.getClassLoader().getResourceAsStream("sample_maven/sample_job_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = sample_job.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : sample_job");
        }
		if(enableLogStash) {
...
/************************************************************************************************
 *     55142 characters generated by Talend Data Fabric 
 *     on the September 24, 2021 10:35:19 AM SGT
 ************************************************************************************************/